    ...
    return (
        <div className="app-content">
                ...
                {FILTERS.map(({ key, label }) => (
                    <button
                        ...
                        style={{
                            ...
                            fontWeight: activeFilter === key ? "var(--font-semibold)" : "var(--font-medium)",
            ...
            <div className="card" style={{ overflow: "hidden" }}>
                {loading ? (
                    ...
                    <div style={{ textAlign: "center", padding: "var(--space-12)", color: "var(--text-secondary)" }}>
                        ...
                        <p style={{ fontWeight: "var(--font-medium)" }}>No tasks yet</p>
                    ...
                    <table style={{ width: "100%", borderCollapse: "collapse" }}>
                        ...
                        <tbody>
                            {filteredTasks.map((task) => {
                                ...
                                return (
                                    <tr key={task.id} style={{ borderBottom: "1px solid var(--border-primary)", transition: "background var(--transition-fast)" }}
                                        onMouseEnter={e => (e.currentTarget.style.background = "var(--bg-secondary)")}
                                        onMouseLeave={e => (e.currentTarget.style.background = "transparent")}
                                    >
                                        <td style={{ padding: "14px 16px" }}>
                                            <div style={{ fontWeight: "var(--font-medium)", fontSize: "var(--text-sm)" }}>{task.title}</div>
                                            {task.description && (
                                        ...
                                        <td style={{ padding: "14px 16px", fontSize: "var(--text-sm)" }}>
                                            <div style={{ fontWeight: "var(--font-medium)" }}>{task.assignedTo.fullName}</div>
                                            {task.assignedTo.designation && (
                                                <div style={{ color: "var(--text-tertiary)", fontSize: "var(--text-xs)" }}>{task.assignedTo.designation}</div>
                                            )}
                                        </td>
                                        ...
                                        <td style={{ padding: "14px 16px" }}>
                                            <span style={{
                                                ...
                                                ...Object.fromEntries(PRIORITY_STYLES[task.priority].split(";").filter(Boolean).map(s => s.split(":").map(v => v.trim()))),
                                            }}>
                                                {task.priority}
                                            </span>
                                        </td>
                                        ...
                                        <td style={{ padding: "14px 16px" }}>
                                            <span style={{
                                                ...
                                                padding: "3px 10px", borderRadius: "var(--radius-full)",
                                                fontSize: "var(--text-xs)", fontWeight: "var(--font-semibold)",
                                                ...Object.fromEntries(STATUS_STYLES[task.status].split(";").filter(Boolean).map(s => s.split(":").map(v => v.trim()))),
                                            }}>
            ...
            <div style={{
                ...
                fontSize: "var(--text-sm)", color: "var(--text-secondary)", flexWrap: "wrap",
            }}>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <form onSubmit={handleAssignSubmit} style={{ display: "flex", flexDirection: "column", gap: "var(--space-4)" }}>
                            ...
                            <div>
                                <label style={{ fontSize: "var(--text-sm)", fontWeight: "var(--font-medium)", display: "block", marginBottom: "var(--space-2)" }}>Assign To *</label>
                                <div style={{ position: "relative" }}>
                                    ...
                                    >
                                        ...
                                        {employees.map(emp => (
                                            <option key={emp.id} value={emp.id}>{emp.fullName} {emp.designation ? `(${emp.designation})` : ""}</option>
                                        ))}
                                    </select>
